  ...
  "walkthrough": [
    {
      ...
      "painBehavior": {
        "text": "收到模糊需求时，默认 agent 要么直接反问「你想蒸馏谁」把用户问住，要么自作主张挑一个人开工，方向错了全程白跑。",
        "evidence": "结构推断"
      },
      "predictBody": [
        {
    ...
    },
    {
      ...
      "painBehavior": {
        "text": "主 agent 检查自己的产物，分数必然偏高——能发现的问题在生成时就不会犯。",
        "evidence": "结构推断"
      },
      "predictBody": [
        {
  ...
  "archive": {
    ...
    "cards": [
      ...
      },
      {
        ...
        "title": "字幕管线脚本化",
        "dimension": "领域-工程",
        "symptom": "agent 手工下了自动生成字幕、没清洗就入库——表达 DNA 统计出此人最高频的「口癖」是「嗯」和整句重复的字幕行。分析结果污染了，但表面看不出来。",
        "evidence": "结构推断",
        "contrast": {
