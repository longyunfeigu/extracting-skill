...
**已生成资产：** `assets/handbook-web-video-presentation/cover-web-video-presentation.png`
...
**已生成资产：** `assets/handbook-web-video-presentation/checkpoint-plan-concept.png`
...
**已生成资产：** `assets/handbook-web-video-presentation/first-chapter-anchor-concept.png`
...
**已生成资产：** `assets/handbook-web-video-presentation/handbook-app-mockup.png`
